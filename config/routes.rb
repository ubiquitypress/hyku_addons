...
HykuAddons::Engine.routes.draw do
  ...
  scope :dashboard do
    resources :orcid_identity, only: %i[new update destroy], controller: "/hyrax/orcid/orcid_identities"
    get "orcid_works/approve/:identity/:work", to: "orcid/works#approve", as: :orcid_works_approval
  end
