  ...
  class PacificUncategorizedForm < Hyrax::Forms::WorkForm
    ...
    def self.build_permitted_params
      super.tap do |permitted_params|
        ...
        permitted_params << [:alt_title,:duration, :version_number, :pagination, :is_included_in, :volume, :issue, :journal_title, :publisher, :isbn, :issn, :additional_links, :degree, :org_unit, :subject, :keyword, :refereed, :irb_status, :irb_number]
      end
    end
  end
end
