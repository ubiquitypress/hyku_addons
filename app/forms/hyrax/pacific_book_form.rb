...
module Hyrax
  class PacificBookForm < Hyrax::Forms::WorkForm
    ...
    add_terms %i[title alt_title resource_type creator contributor abstract date_published
                 ...
                 rights_holder license org_unit official_link subject keyword refereed add_info]
    self.terms -= %i[language rights_statement]
    self.required_fields = %i[title creator resource_type abstract org_unit pagination publisher]
