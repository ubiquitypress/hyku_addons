  ...
  class NsuArticleForm < Hyrax::Forms::WorkForm
    ...
    def self.build_permitted_params
      super.tap do |permitted_params|
        ...
        permitted_params << [:title, :resource_type, :creator, :alt_email, :abstract, :keyword, :subject, :degree,
                             ...
                             :adapted_from, :series_name, :source, :isbn, :issn, :eissn, :publisher,
                             :place_of_publication, :funder, :license, :rights_holder, :rights_statement, :contributor,
