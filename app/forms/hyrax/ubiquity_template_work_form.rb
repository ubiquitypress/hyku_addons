...
module Hyrax
  ...
  class UbiquityTemplateWorkForm < Hyrax::Forms::WorkForm
    ...
    add_terms %i[title alt_title resource_type creator contributor abstract date_published media duration
                 ...
                 language license rights_statement rights_holder doi qualification_name qualification_level alternate_identifier
