  ...
  class NsuGenericWorkForm < Hyrax::Forms::WorkForm
    ...
    def self.build_permitted_params
      super.tap do |permitted_params|
        ...
        permitted_params << [:alt_email, :abstract, :keyword, :subject, :degree, :qualification_level, :irb_status,
                             :qualification_name, :advisor, :org_unit, :date_published, :book_title, :alt_book_title,
                             ...
                             :editor, :date_accepted, :date_submitted, :table_of_contents, :references, :medium,
                             :extent, :duration, :language, :audience, :prerequisites, :location, :longitude, :latitude,
                             :time, :refereed, :suggested_reviewers, :suggested_student_reviewers, :irb_number, :add_info]
      end
    end
  end
end
