  ...
  module WorkIndexerBehavior
    ...
    def generate_solr_document
      super.tap do |solr_doc|
        ...
        solr_doc[Solrizer.solr_name("date_published", :stored_sortable)] = object&.date_published if object.respond_to? :date_published
      end
    end
    ...
    def format_names(field)
      return nil if object&.send(field)&.first.blank?
