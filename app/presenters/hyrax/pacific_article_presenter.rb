...
module Hyrax
  class PacificArticlePresenter < Hyrax::WorkShowPresenter
    ...
    DELEGATED_METHODS = %i[title alt_title resource_type creator creator_json contributor abstract institution date_published pagination issue page_display_order_number
