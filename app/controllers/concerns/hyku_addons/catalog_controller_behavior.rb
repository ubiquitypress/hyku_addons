  ...
  module CatalogControllerBehavior
    ...
    included do
      ...
      configure_blacklight do |config|
        ...
        config.add_facet_field solr_name("audience", :facetable), limit: 5, label: 'OER Audience', if: Proc.new {|context, config, opts| context.current_account.locale == "redlands"}
