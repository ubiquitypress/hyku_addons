  ...
  module CatalogControllerBehavior
    ...
    included do
      ...
      configure_blacklight do |config|
        ...
        config.add_facet_field "org_unit_tesim", limit: 5, label: 'Department'
        config.add_facet_field "audience_tesim", limit: 5, label: 'OER Audience', if: proc { |context, _config, _opts| context.current_account&.settings&.dig("locale_name") == "redlands" }
