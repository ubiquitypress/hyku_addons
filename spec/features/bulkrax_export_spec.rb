...
RSpec.describe 'Bulkrax export', clean: true, perform_enqueued: true do
  ...
  describe 'single object export' do
    ...
    it 'populates all fields' do
      ...
      expect(parsed_metadata['identifier'].split('|')).to contain_exactly('3-921099-34-X', 'doi:10.1038/nphys1170', 'ISBN:978-83-7659-303-6', '9790879392788', '3-540-49698-x', '0-19-852663-6', '978-3-540-49698-4')
    end
  end
