...
RSpec.feature "Create a DenverSerialPublication", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title alt_title resource_type alt_email institution abstract keyword subject
                                  org_unit journal_title journal_frequency volume
                                  issue pagination official_link library_of_congress_classification
                                  issn eissn publisher place_of_publication license
                                  rights_holder rights_statement medium extent
