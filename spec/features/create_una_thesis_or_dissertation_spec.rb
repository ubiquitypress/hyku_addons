  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title resource_type alt_email abstract keyword subject
                   ...
                   advisor committee_member org_unit additional_links related_material
                   related_url place_of_publication citation license rights_holder
                   rights_statement rights_statement_text language location longitude
                   latitude georeferenced add_info]
