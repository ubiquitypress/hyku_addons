...
RSpec.feature "Create a UnaBook", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title alt_title resource_type alt_email abstract
                                  ...
                                  table_of_contents publisher place_of_publication
                                  edition isbn official_link series_name
                                  location longitude latitude add_info buy_book]
