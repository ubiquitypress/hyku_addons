...
RSpec.feature "Create a DenverPresentationMaterial", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title resource_type institution abstract keyword
                                  subject org_unit event_title event_location license
                                  rights_holder rights_statement language add_info]
    ...
    it "renders all date fields" do
      worktype_date_fields = %w[date_published event_date]
