...
RSpec.feature "Create a DenverArticle", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title alt_title resource_type institution abstract keyword subject org_unit
                                  journal_title alternative_journal_title volume issue pagination
                                  mesh license rights_holder rights_statement language refereed irb_number add_info]
