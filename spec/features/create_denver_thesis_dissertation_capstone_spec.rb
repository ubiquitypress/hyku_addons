...
RSpec.feature "Create a DenverThesisDissertationCapstone", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title resource_type institution abstract keyword subject degree qualification_level
                                  qualification_name advisor committee_member org_unit
                                  pagination library_of_congress_classification
                                  publisher place_of_publication license rights_holder rights_statement
                                  table_of_contents references medium extent language add_info]
