...
RSpec.feature "Create a UnaArchivalItem", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all date fields" do
      worktype_date_fields = %w[date_published related_exhibition_date event_date]
