...
RSpec.feature "Create a UngImage", js: true, slow: true do
  ...
  context "when the form is filled out" do
    before do
      ...
      # undefined method `doi_registrar'
    ...
    describe "submitting the form" do
      ...
      xit "redirects to the work show page" do
        ...
        aggregate_failures "testing the saved data" do
          ...
          expect(work.event_date).to eq([normalize_date(event_date.first)])
          ...
          expect(work.related_exhibition_date).to eq([normalize_date(related_exhibition_date.first)])
