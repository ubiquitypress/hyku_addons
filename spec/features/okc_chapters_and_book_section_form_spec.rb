...
RSpec.feature "Create a OkcChaptersAndBookSection", js: true, slow: true do
  let(:work_type) { "okc_chapters_and_book_section" }
  ...
  let(:rights_statement_options) { HykuAddons::RightsStatementService.new(model: model).active_elements.sample(2) }
