...
RSpec.feature "Create a DenverBook", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title alt_title resource_type institution abstract keyword subject_text org_unit
                                  edition library_of_congress_classification
                                  isbn publisher place_of_publication license rights_holder rights_statement
                                  table_of_contents medium extent language time refereed add_info]
