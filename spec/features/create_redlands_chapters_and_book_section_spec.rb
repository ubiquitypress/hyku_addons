...
RSpec.feature "Create a RedlandsChaptersAndBookSection", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title alt_title resource_type alt_email abstract keyword subject
                                  org_unit language license version_number publisher place_of_publication book_title
                                  alt_book_title edition pagination isbn official_link series_name location
