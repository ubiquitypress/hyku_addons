...
RSpec.feature "Create a DenverMap", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title alt_title resource_type abstract keyword subject_text
                                  org_unit publisher place_of_publication event_title event_location license
                                  rights_holder rights_statement extent language location
