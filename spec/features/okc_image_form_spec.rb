...
RSpec.feature "Create a OkcImage", js: true, slow: true do
  let(:work_type) { "okc_image" }
  ...
  let(:subject_options) { HykuAddons::SubjectService.new(model: model).active_elements.sample(1) }
