...
RSpec.feature "Create a RedlandsConferencesReportsAndPaper", redlands: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title alt_title resource_type alt_email abstract keyword subject
                                  org_unit language license publisher event_location official_link
                                  location longitude latitude add_info]
