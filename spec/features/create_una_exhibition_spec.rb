...
RSpec.feature "Create a UnaExhibition", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title alt_title resource_type
                                  alt_email abstract keyword subject subject_text
                                  official_link citation project_name fndr_project_ref
                                  event_title event_location related_exhibition
                                  related_exhibition_venue license rights_holder
                                  rights_statement rights_statement_text
                                  medium extent duration is_format_of language location
                                  longitude latitude georeferenced time refereed
    ...
    it "renders complex identifier fields" do
      worktype_complex_fields = %w[alternate_identifier]
