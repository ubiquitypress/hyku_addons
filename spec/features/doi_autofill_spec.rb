...
RSpec.describe 'autofilling the form from DOI', js: true do
  include_context 'create work user context' do
    ...
    scenario do
      ...
      # expect(page).to have_field('generic_work_creator__creator_family_name', with: 'Fenner')
      # expect(page).to have_field('generic_work_creator__creator_given_name', with: 'Martin')
      # expect(page).to have_field('generic_work_abstract', with: 'Eating your own dog food is a slang term to describe that an organization '\
