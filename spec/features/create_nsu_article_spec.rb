...
RSpec.feature "Create a NsuArticle", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title resource_type alt_email abstract
                                  ...
                                  advisor committee_member org_unit journal_title
                                  ...
                                  issn eissn publisher place_of_publication license rights_holder
                                  rights_statement table_of_contents references medium extent
