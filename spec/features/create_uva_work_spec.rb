...
RSpec.feature "Create a UvaWork", customer: true do
  ...
  context "when rendering the form" do
    ...
    it "renders all simple worktype fields" do
      worktype_simple_fields = %w[title resource_type abstract license keyword language
                                  publisher related_url add_info]
