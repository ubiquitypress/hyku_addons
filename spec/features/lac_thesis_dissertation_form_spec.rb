...
RSpec.feature "Create a LacThesisDissertation", js: true, slow: true do
  let(:work_type) { "lac_thesis_dissertation" }
  ...
  context "when the form is filled out" do
    before do
      ...
      fill_in_multiple_text_fields(:related_material, related_material)
