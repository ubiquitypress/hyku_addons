...
RSpec.describe Hyrax::ImageForm do
  ...
  describe "#terms" do
    ...
    it do
      expected_terms = [:title, :alt_title, :resource_type, :creator, :contributor, :abstract, :date_published, :media,
                        :duration, :institution, :org_unit, :project_name, :funder, :fndr_project_ref, :publisher,
