      ...
      context 'with data when it exists' do
        ...
        it 'returns work json' do
          ...
          expect(json_response).to include("abstract" => "Swedish comic about the adventures of the residents of Moominvalley.",
                                           ...
                                           "collections" => [],
                                           "committee_member" => nil,
                                           "contributor" => [{ "contributor_family_name" => "Gnitset", "contributor_given_name" => "Jannet", "contributor_name_type" => "Personal", "contributor_orcid" => "https://orcid.org/0000-1234-5109-3702" }],
                                           "creator" => [{ "creator_family_name" => "Hageneuer", "creator_given_name" => "Sebastian", "creator_name_type" => "Personal", "creator_orcid" => "https://sandbox.orcid.org/0000-0003-0652-4625" }, { "creator_family_name" => "Testing", "creator_given_name" => "Johnny", "creator_name_type" => "Personal" }],
